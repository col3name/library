 ...
 */
final class Version20180704224444 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task_genre (task_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_44F428D88DB60186 (task_id), INDEX IDX_44F428D8BAD26311 (tag_id), PRIMARY KEY(task_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task_genre DROP FOREIGN KEY FK_44F428D8BAD26311');
